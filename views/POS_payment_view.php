...
<script>
    handlePOS([5, 10, 25], [5, 10, 25, 50], ['headQty', 'headItem', 'headPrice', 'headAmt', 'headDisc'],
                <?php echo $GSTrate;?>, <?php echo $ServiceCharge;?>, '<?php echo addslashes(htmlspecialchars($Time));?>', '<?php echo escape(htmlspecialchars($Name));?>',
                '<?php echo escape(htmlspecialchars($Address));?>', <?php echo $Table;?>, '<?php echo escape(htmlspecialchars($Remarks));?>');
