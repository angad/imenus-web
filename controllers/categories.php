...
define('EDITTITLE', 'Click to Edit');
 ...
 class Categories extends CI_Controller {
 	...
 	{     
        ...
        $this->load->view('content_view', array('title' => 'Categories', 'content' => $this->table->generate(), 'include_scripts' => array('http://www.appelsiini.net/download/jquery.jeditable.mini.js'), 'document_ready' => '$(".edit").editable("'.$this->config->site_url().'/categories/rename/'.$menuID.'");'));
 	}
